...
if GHUD_AR_show_sight == true then --AR sight for selected target
    ...
    if id ~= nil then
       ...
       local x1,y1,z1 = ConvertLocalToWorld(0,distance,0)
       local point1 = library.getPointOnScreen({x1,y1,z1})
