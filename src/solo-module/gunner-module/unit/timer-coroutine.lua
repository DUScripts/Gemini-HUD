...
if GHUD_AR_show_sight == true then --AR sight for selected target
   ...
   if point1[3] > 0 then --visible zone
      ...
      <text style="fill: white; font-family: verdana; font-size: 26px; font-weight: 700; paint-order: stroke; stroke: rgb(0, 0, 0); stroke-width: 2px; text-anchor: middle; white-space: pre;" transform="matrix(1, 0, 0, 1, 45.470986, 456.61146)"><tspan x="254.529" y="60.003">0.0M</tspan></text>
