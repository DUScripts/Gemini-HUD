...
if id ~= 0 then
   ...
   local name = string.sub((""..radar_1.getConstructName(id)..""),1,11)
   ...
   if point1[3] > 0 then --visible zone
      ...
      <text style="fill: ]]..newcolor..[[; font-family: verdana; font-size: 26px; font-weight: 700; paint-order: stroke; stroke: rgb(0, 0, 0); stroke-width: 2px; text-anchor: start;" y="310.246" x="494">]]..speed .. znak..[[</text>
      </svg></div>]]
else
