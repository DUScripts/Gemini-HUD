...
]]end;function p.marker(q)return[[<svg class="icon ]]..iconStatusCheck(q)..[[" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148.21 197.07">
...
]]end;function p.ship(q)return[[<svg class="icon ]]..iconStatusCheck(q)..[[" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 196.27 188.83">
...
]]end;function p.player(q)return[[<svg class="icon ]]..iconStatusCheck(q)..[[" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 63.36 198">
