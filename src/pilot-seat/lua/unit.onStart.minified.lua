...
<text x="%f" y="%f" font-size="11px" fill="yellow">%s</text>
      ...
      .warp-scan {
         ...
         background: #ff3a56;
                        ...
                        </div>]]end end end;local cM=0;local cN=0;local cO=0;if activeRadar.isConstructIdentified(aW)==1 and size~=""then local cE=activeRadar.getConstructName(aW)local cH=math.floor(activeRadar.getConstructDistance(aW))if cH>=1000 then cH=''..string.format('%0.1f',cH/1000)..' km ('..string.format('%0.2f',cH/200000)..' su)'else cH=''..cH..' m'end;local cP=tostring(aW):sub(-3)local cQ=''..cP..' '..cE..''isILock=true;cM=math.floor(activeRadar.getConstructSpeed(aW)*3.6)if activeRadar.getTargetId(aW)==aW then ct=ct..[[
                     <div class="table-row2 thS">
                     <div class="table-cellS">
                     ]]..'['..size..'] '..cQ..[[ <speedcolor> ]]..cM..[[ km/h</speedcolor><br><distcolor>]]..cH..[[</distcolor>
                     </div>
                     </div>]]else ct=ct..[[
                     ...
                     </div>]]end else if GHUD_show_echoes==true then if size~=""then if activeRadar.getConstructKind(aW)==5 then table.insert(radarDynamic,cD)if radarDynamicWidget[cD.widgetDist]~=nil then radarDynamicWidget[cD.widgetDist]=radarDynamicWidget[cD.widgetDist]+1 else radarDynamicWidget[cD.widgetDist]=1 end else table.insert(radarStatic,cD)if radarStaticWidget[cD.widgetDist]~=nil then radarStaticWidget[cD.widgetDist]=radarStaticWidget[cD.widgetDist]+1 else radarStaticWidget[cD.widgetDist]=1 end end end end end;if(activeRadar.getThreatRateFrom(aW)==2 or activeRadar.getThreatRateFrom(aW)==3 or activeRadar.getThreatRateFrom(aW)==5)and size~=""then co=co+1;local cE=string.sub(""..activeRadar.getConstructName(aW).."",1,11)local cH=math.floor(activeRadar.getConstructDistance(aW))if cH>=1000 then cH=''..string.format('%0.1f',cH/1000)..' km ('..string.format('%0.2f',cH/200000)..' su)'else cH=''..cH..' m'end;local cR=tostring(aW):sub(-3)local cS=''..cR..' '..cE..''if activeRadar.getThreatRateFrom(aW)==5 then cp=cp+1;cs=cs..[[
                     <div class="table-row th">
                     <div class="lockedT">
                     <redcolor1>]]..'['..size..'] '..cS..[[</redcolor1><br><distcolor>]]..cH..[[</distcolor>
                     </div>
                     </div>]]else cs=cs..[[
                     <div class="table-row th">
                     <div class="lockedT">
                     <orangecolor>]]..'['..size..'] '..cS..[[</orangecolor><br><distcolor>]]..cH..[[</distcolor>
                     </div>
                     </div>]]end end;if G>50 then G=0;coroutine.yield()end end;if GHUD_show_allies==true then if cn>0 then cu="<alliescolor>Allies:</alliescolor><br><countcolor>"..cn.."</countcolor> <countcolor2>"..conID.."</countcolor2>"else cu="<alliescolor>Allies:</alliescolor><br><countcolor>0</countcolor> <countcolor2>"..conID.."</countcolor2>"end;ck=htmlbasic..[[
               <style>
               .th3>.table-cell3 {
               ...
               </div>]]end;cu="<targetscolor>Targets:</targetscolor>"cw=targetshtml..[[
            <style>
            .th2>.table-cell2 {
            ...
            <div class="table-row2 th2">
            <div class="table-cell2">
            ]]..cu..[[<br><countcolor>]]..idN-cn..[[</colorcount>
            </div>
            </div>
            ]]..ct..[[
            </div>]]if co==0 then cv="LOCK"cB="#07e88e"cz="OK"cA=cB else cv="LOCKED:"cB="#FFB12C"cz=co;cA="rgb(0, 191, 255)"end;if cp>0 then cv="ATTACKED:"cB="#fc033d"cz=cp;cA="rgb(0, 191, 255)"end;cy=[[<style>.radarLockstatus {
               position: fixed;
            ...
            <text style="fill: ]]..cA..[[; font-size: 110px; font-weight: bold; text-anchor: middle;" x="256" y="294.054">]]..cz..[[</text>
            </svg>
            </div>]]cx=lockhtml..[[
            <style>
            .th>.table-cell {
            ...
            <rightlocked style="color: ]]..cB..[[;">]]..cv..[[</rightlocked>
            </div>
            </div>
            ]]..cs..[[
            </div>]]if GHUD_show_echoes==true then local cT=''for cC,aW in pairs(radarDynamicData)do cT=cT..'<span style="left:'..cC..'px;height:'..aW..'px;"></span>'end;local cU=''for cC,aW in pairs(radarStaticData)do cU=cU..'<span style="left:'..cC..'px;height:'..aW..'px;"></span>'end;local htmlRadar=htmlRadar..[[
               <div class="radar-widget">
               <div class="d-widget">]]..cT..[[</div>
               <div class="s-widget">]]..cU..[[</div>
               <div class="labels">
               ...
               ]]radarWidget=htmlRadar else radarWidget=''end;cl=hudvers..[[<div class="hudversion">GHUD v]]..HUD_version..[[</div>]]if GHUD_show_echoes==true then if GHUD_show_allies==true then gunnerHUD=ck..cw..cx..cl..radarWidget..cy else gunnerHUD=cw..cx..cl..radarWidget..cy end else if GHUD_show_allies==true then gunnerHUD=ck..cw..cx..cl..cy else gunnerHUD=cw..cx..cl..cy end end;coroutine.yield()end end;lockhtml=[[<style>
      .table {
         display: table;
      ...
      .warp-scan {
      ...
      </style>]]function zeroConvertToWorldCoordinates(d,system)local e=" *([+-]?%d+%.?%d*e?[+-]?%d*)"local f="::pos{"..e..","..e..","..e..","..e..","..e.."}"local g,h,i,j,k=string.match(d,f)if g==nil or h==nil or i==nil or j==nil or k==nil then system.print("Invalid POS!")return vec3()end;if g=="0"and h=="0"then return vec3(i,j,k)end;j=math.rad(j)i=math.rad(i)local l=atlas[tonumber(g)][tonumber(h)]local m=math.cos(i)local n=vec3(m*math.cos(j),m*math.sin(j),math.sin(i))return vec3(l.center)+(l.radius+k)*n end;function getPipeD(system)if databank_1.getStringValue(1)~=""and databank_1.getStringValue(3)~=""then local aD=""local length1=-700*200000;local cV=800*200000;local cW=pos1;local cX=pos2;local pos111=zeroConvertToWorldCoordinates(cW,system)local pos222=zeroConvertToWorldCoordinates(cX,system)local DestinationCenter=vectorLengthen(pos111,pos222,length1)local DepartureCenter=vectorLengthen(pos111,pos222,cV)local cY=vec3(construct.getWorldPosition())local x=(DestinationCenter-DepartureCenter):normalize()local z=(cY-DepartureCenter):dot(x)/x:dot(x)if z<=0.then return(cY-DepartureCenter):len()elseif z>=(DestinationCenter-DepartureCenter):len()then return(cY-DestinationCenter):len()end;local A=DepartureCenter+z*x;local J=(A-cY):len()if J<1000 then aD=""..string.format("%0.0f",J).." m"elseif J<100000 then aD=""..string.format("%0.1f",J/1000).." km"else aD=""..string.format("%0.2f",J/200000).." su"end;return aD end end;function getPipeW(system)if databank_1.getStringValue(1)~=""and databank_1.getStringValue(3)~=""then showMarker=false;local length1=-700*200000;local cV=800*200000;local cW=pos1;local cX=pos2;local pos111=zeroConvertToWorldCoordinates(cW,system)local pos222=zeroConvertToWorldCoordinates(cX,system)local DestinationCenter=vectorLengthen(pos111,pos222,length1)local DepartureCenter=vectorLengthen(pos111,pos222,cV)local cY=vec3(construct.getWorldPosition())local x=(DestinationCenter-DepartureCenter):normalize()local z=(cY-DepartureCenter):dot(x)/x:dot(x)if z<=0.then return(cY-DepartureCenter):len()elseif z>=(DestinationCenter-DepartureCenter):len()then return(cY-DestinationCenter):len()end;local A=DepartureCenter+z*x;local cZ="::pos{0,0,"..math.floor(A.x)..","..math.floor(A.y)..","..math.floor(A.z).."}"system.print("Pipe center")system.setWaypoint(cZ)end end;function getPos4Vector(c_)return"::pos{0,0,"..vec3(c_).x..","..vec3(c_).y..","..vec3(c_).z.."}"end;function makeVector(as,at)local au=vec3(at).x-vec3(as).x;local y=vec3(at).y-vec3(as).y;local av=vec3(at).z-vec3(as).z;return vec3(au,y,av)end;function UTC()local d0=curTime-timeZone*3600;return d0 end;function UTCscaner(system)local d0=system.getArkTime()-timeZone*3600;return d0 end;function vectorLengthen(as,at,aw)local ax=makeVector(as,at)local ay=vec3(ax):len()local az=ay+aw;local aA=az/ay;local aB=ax*aA;local au=vec3(as).x+vec3(aB).x;local y=vec3(as).y+vec3(aB).y;local av=vec3(as).z+vec3(aB).z;local aC=vec3(au,y,av)return aC end;function start(unit,system,text)pos1time=0;pos2time=0;tspeed=0;tspeed1=0;mmode=true;deg2rad=math.pi/180;rad2deg=180/math.pi;ms2kmh=3600/1000;kmh2ms=1000/3600;showMarker=true;if GHUD_export_mode==true then system.print("---------------")system.print("The export mode is enabled ALT+G")else system.print("---------------")system.print("The export mode is disabled ALT+G")end;SU=10;calcTargetSpeed=targetSpeed/3.6;meterMarker=0;if databank_1.getStringValue(1)~=""and databank_1.getFloatValue(2)~=0 and databank_1.getStringValue(3)~=""and databank_1.getFloatValue(4)~=0 then system.print("Coordinates from DB are used!")pos1=databank_1.getStringValue(1)pos2=databank_1.getStringValue(3)pos1time=databank_1.getFloatValue(2)pos2time=databank_1.getFloatValue(4)pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)Pos1=pos1;Pos2=pos2;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;curTime=system.getUtcTime()local lasttime=math.floor(curTime-pos2time)local d1=pos11:dist(pos22)local d2=pos2time-pos1time;tspeed=d1/d2;tspeed1=math.floor(d1/d2*3.6)meterMarker1=lasttime*tspeed+tspeed*4;length1=meterMarker1;lengthSU1=string.format("%0.2f",length1/200000*100/100)meterMarker=lasttime*calcTargetSpeed+calcTargetSpeed*4;length=meterMarker;lengthSU=string.format("%0.2f",length/200000*100/100)resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)system.print("The target flew 20 km "..lengthSU1 .." su, speed "..tspeed1 .." km/h")unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)else databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;system.print("Coordinates are missing set new or export")end end;function inTEXT(unit,system,text)if pos1~=0 and string.find(text,"::pos")and not string.find(text,"m::pos")and pos2==0 and GHUD_export_mode==false then pos2=text;databank_1.setStringValue(3,pos2)pos2time=math.floor(system.getUtcTime())databank_1.setFloatValue(4,pos2time)system.print(text.." pos2 saved")pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)local d1=pos11:dist(pos22)local d2=pos2time-pos1time;tspeed=d1/d2;tspeed1=math.floor(d1/d2*3.6)Pos1=pos1;Pos2=pos2;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;meterMarker1=meterMarker1+tspeed*4;length1=meterMarker1;resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)meterMarker=meterMarker+calcTargetSpeed*4;length=meterMarker;resultVector=vectorLengthen(pos11,pos22,length)Waypoint=getPos4Vector(resultVector)system.print("---------------")system.print("The coordinates are set manually!")posExport1=databank_1.getStringValue(1)posExport2=databank_1.getStringValue(3)timeExport1=math.floor(databank_1.getFloatValue(2))timeExport2=math.floor(databank_1.getFloatValue(4))system.print("The coordinates were exported to screen")screen_1.setCenteredText(posExport1 .."/"..timeExport1 .."/"..posExport2 .."/"..timeExport2)system.print("Target speed: "..tspeed1 .." km/h")unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)end;if pos1==0 and string.find(text,"::pos")and not string.find(text,"m::pos")and GHUD_export_mode==false then pos1=text;databank_1.setStringValue(1,pos1)pos1time=math.floor(system.getUtcTime())databank_1.setFloatValue(2,pos1time)system.print(text.." pos1 saved")end;if text=="n"then pp1=''unit.stopTimer("marker")showMarker=true;databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;SU=10;unit.stopTimer("vectorhud")vectorHUD=''Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;system.print("---------------")system.print("Coordinates have been deleted, set new coordinates")end;if GHUD_export_mode==true and string.find(text,"/")and not string.find(text,"/::pos")then unit.stopTimer("marker")showMarker=true;databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;SU=10;unit.stopTimer("vectorhud")vectorHUD=''Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;local start=0;local d3=string.find(text,"/",start)-1;pos1=string.sub(text,start,d3)system.print(pos1)start=d3+2;d3=string.find(text,"/",start)-1;pos1time=tonumber(string.sub(text,start,d3))system.print(pos1time)start=d3+2;d3=string.find(text,"/",start)-1;pos2=string.sub(text,start,d3)system.print(pos2)start=d3+2;d3=string.find(text,"/",start)pos2time=tonumber(string.sub(text,start,d3))system.print(pos2time)system.print("---------------")system.print("The coordinates have been loaded successfully!")databank_1.setStringValue(1,pos1)databank_1.setFloatValue(2,pos1time)databank_1.setStringValue(3,pos2)databank_1.setFloatValue(4,pos2time)pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)Pos1=pos1;Pos2=pos2;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;oldTime=tonumber(string.sub(text,start,d3))curTime=system.getUtcTime()local lasttime=math.floor(curTime-pos2time)local d1=pos11:dist(pos22)local d2=pos2time-pos1time;tspeed=d1/d2;tspeed1=math.floor(d1/d2*3.6)meterMarker1=lasttime*tspeed+tspeed*4;length1=meterMarker1;lengthSU1=string.format("%0.2f",length1/200000*100/100)meterMarker=lasttime*calcTargetSpeed+calcTargetSpeed*4;length=meterMarker;lengthSU=string.format("%0.2f",length/200000*100/100)resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)system.print("The target flew "..lengthSU1 .." su, speed "..tspeed1 .." km/h")system.setWaypoint(Waypoint1)unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)end;if GHUD_export_mode==true and string.find(text,"/::pos")then unit.stopTimer("marker")showMarker=true;databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;SU=10;unit.stopTimer("vectorhud")vectorHUD=''Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;local start=0;local d3=string.find(text,"/",start)-1;pos1=string.sub(text,start,d3)system.print(pos1)start=d3+2;d3=string.find(text,"/",start)-1;pos1time=tonumber(string.sub(text,start,d3))system.print(pos1time)start=d3+2;d3=string.find(text,"/",start)-1;pos2=string.sub(text,start,d3)system.print(pos2)start=d3+2;d3=string.find(text,"/",start)pos2time=tonumber(string.sub(text,start,d3))system.print(pos2time)system.print("---------------")system.print("The coordinates have been loaded successfully!")databank_1.setStringValue(1,pos1)databank_1.setFloatValue(2,pos1time)databank_1.setStringValue(3,pos2)databank_1.setFloatValue(4,pos2time)pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)Pos1=pos1;Pos2=pos2;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;oldTime=tonumber(string.sub(text,start,d3))curTime=system.getUtcTime()local lasttime=math.floor(curTime-pos2time)local d1=pos11:dist(pos22)local d2=pos2time-pos1time;tspeed=d1/d2;tspeed1=math.floor(d1/d2*3.6)meterMarker1=lasttime*tspeed+tspeed*4;length1=meterMarker1;lengthSU1=string.format("%0.2f",length1/200000*100/100)meterMarker=lasttime*calcTargetSpeed+calcTargetSpeed*4;length=meterMarker;lengthSU=string.format("%0.2f",length/200000*100/100)resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)system.print("The target flew "..lengthSU1 .." su, speed "..tspeed1 .." km/h")system.setWaypoint(Waypoint1)unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)end;if string.find(text,"mar")then if showMarker==true then showMarker=false;system.print("Current target position - OFF")end;local d4=tonumber(text:sub(4))if databank_1.getStringValue(1)~=""and databank_1.getStringValue(3)~=""then local cV=d4*200000;local cW=databank_1.getStringValue(1)local cX=databank_1.getStringValue(3)pos111=zeroConvertToWorldCoordinates(cW,system)pos222=zeroConvertToWorldCoordinates(cX,system)local d5=vectorLengthen(pos111,pos222,cV)local d6=getPos4Vector(d5)system.print(d6 .." waypoint "..d4 .." su")end end end;function tickVector(unit,system,text)if targetTracker==true and targetVector.x~=0 and targetVector.y~=0 and targetVector.z~=0 then local d7=getPipeD(system)local d8=vec3(construct.getWorldOrientationUp()):normalize()local d9=vec3(construct.getWorldOrientationRight()):normalize()local da=vec3(construct.getWorldOrientationForward()):normalize()local db=vec3(construct.getWorldVelocity()):normalize()local dc=db:project_on_plane(d8)local dd=db:project_on_plane(d9)local de=db:project_on_plane(da)local df=de:cross(d8):normalize()myAngleR=dc:angle_between(da)local dg=utils.sign(df:angle_between(da)-math.pi/2)if dg~=0 then myAngleR=myAngleR*dg;privMySignAngleR=dg else myAngleR=myAngleR*privMySignAngleR end;local dh=dd:cross(d8):normalize()myAngleUp=dd:angle_between(-d8)-math.pi/2;local di=utils.sign(dh:angle_between(d9)-math.pi/2)if di~=0 then myAngleUp=myAngleUp*di;privMySignAngleUp=di else myAngleUp=myAngleUp*privMySignAngleUp end;local dj=targetVector:normalize()local dk=dj:project_on_plane(d8)local dl=dj:project_on_plane(d9)local dm=dj:project_on_plane(da)local dn=dm:cross(d8):normalize()targetAngleR=dk:angle_between(da)local dp=utils.sign(dn:angle_between(da)-math.pi/2)if dp~=0 then targetAngleR=targetAngleR*dp;privTargetSignAngleR=dp else targetAngleR=targetAngleR*privTargetSignAngleR end;local dq=dl:cross(d8):normalize()targetAngleUp=dl:angle_between(-d8)-math.pi/2;local dr=utils.sign(dq:angle_between(d9)-math.pi/2)if dr~=0 then targetAngleUp=targetAngleUp*dr;privTargetSignAngleUp=dr else targetAngleUp=targetAngleUp*privTargetSignAngleUp end;targetVectorWidget=[[
         ...
         <br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..dM..[[</bdr> : switch between friends/enemies<br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..dL..[[</bdr> : construct size filter<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>]]..dx..[[</bdr> : add/remove selected target from whitelist<br>
         </div>
         <div class="helper2">
         <ibold>TARGET VECTOR:</ibold>
         <br>
         <br>
         <bdr>]]..dH..[[</bdr> : set pos1/pos2 for radar selected target<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>↓↑</bdr> : move destination ±2.5 su<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>←→</bdr> : move destination ±10 su<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>]]..dI..[[</bdr> : destination to closest target pipe<br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..dH..[[</bdr> : on/off export mode<br>
         <br>
         <bdr>]]..dU..[[</bdr> : show/hide current target position (works only when manually setting coordinates or in export mode)<br>
         <br>
         <bdr>]]..dH..[[</bdr> + <bdr>]]..dA..[[</bdr> : switch target position between current speed or targetSpeed from LUA parameters<br>
         </div>
         </div>
         <div class="bottomL">
         <div class="helper3">
         ...
         <br>
         <br>
         <bdr>]]..dF..[[</bdr> : start/stop venting<br>
         <br>
         <bdr>]]..dE..[[</bdr> : on/off shield<br>
         <br>
         <bdr>]]..dD..[[</bdr> : switch AUTO/MANUAL shield mode<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>]]..dD..[[</bdr> : switch shield mode between MAX and 50/50 mode<br>
         <br>
         <bdr>]]..dC..[[</bdr> : agree and apply resists in manual shield mode<br>
         <br>
         <bdr>]]..dL..[[</bdr> + <bdr>]]..dx..[[</bdr> : 100% antimatter power<br>
         <br>
         <bdr>]]..dL..[[</bdr> + <bdr>]]..dy..[[</bdr> : 100% electromagnetic power<br>
         <br>
         <bdr>]]..dL..[[</bdr> + <bdr>]]..dz..[[</bdr> : 100% thermic power<br>
         <br>
         <bdr>]]..dL..[[</bdr> + <bdr>]]..dA..[[</bdr> : 100% kinetic power<br>
         <br>
         <bdr>]]..dM..[[</bdr> + <bdr>]]..dx..[[</bdr> : cannon profile<br>
         <br>
         <bdr>]]..dM..[[</bdr> + <bdr>]]..dy..[[</bdr> : railgun profile<br>
         <br>
         <bdr>]]..dM..[[</bdr> + <bdr>]]..dz..[[</bdr> : laser profile<br>
         <br>
         <bdr>]]..dM..[[</bdr> + <bdr>]]..dA..[[</bdr> : universal profile<br>
         </div>
         <div class="helper2">
         <ibold>Other:</ibold>
         <br>
         <br>
         <bdr>]]..dS..[[</bdr> + <bdr>]]..dG..[[</bdr> : lock brake<br>
         <br>
         <bdr>]]..dx..[[</bdr> : show/hide planets and planetary periscope<br>
         <br>
         <bdr>]]..dy..[[</bdr> : set destination to planet #1 (closest pipe planets)<br>
         <br>
         <bdr>]]..dz..[[</bdr> : set destination to closest pipe<br>
         <br>
         <bdr>]]..dA..[[</bdr> : set destination to planet #2 (closest pipe planets)<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>]]..dy..[[</bdr> : set destination to destination planet (LUA parameters)<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>]]..dz..[[</bdr> : set destination to custom pipe Destination - Departure (LUA parameters)<br>
         <br>
         <bdr>]]..dG..[[</bdr> + <bdr>]]..dA..[[</bdr> : set destination to departure planet (LUA parameters)<br>
         <br>
         <bdr>]]..dB..[[</bdr> : Helios system map<br>
         </div>
         </div>
         <div class="bottomL">
         <div class="helper3">
