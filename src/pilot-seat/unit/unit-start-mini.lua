...
<text x="%f" y="%f" font-size="11px" fill="yellow">%s</text>
      ...
      .warp-scan {
         ...
         background: #ff3a56;
                        ...
                        </div>]]end end end;local cJ=0;local cK=0;local cL=0;if activeRadar.isConstructIdentified(aW)==1 and size~=""then local cC=activeRadar.getConstructName(aW)local cE=math.floor(activeRadar.getConstructDistance(aW))if cE>=1000 then cE=''..string.format('%0.1f',cE/1000)..' km ('..string.format('%0.2f',cE/200000)..' su)'else cE=''..cE..' m'end;local cM=tostring(aW):sub(-3)local cN=''..cM..' '..cC..''isILock=true;cJ=math.floor(activeRadar.getConstructSpeed(aW)*3.6)if activeRadar.getTargetId(aW)==aW then cr=cr..[[
                     <div class="table-row2 thS">
                     <div class="table-cellS">
                     ]]..'['..size..'] '..cN..[[ <speedcolor> ]]..cJ..[[ km/h</speedcolor><br><distcolor>]]..cE..[[</distcolor>
                     </div>
                     </div>]]else cr=cr..[[
                     ...
                     </div>]]end else if GHUD_show_echoes==true then if size~=""then if activeRadar.getConstructKind(aW)==5 then table.insert(radarDynamic,cB)if radarDynamicWidget[cB.widgetDist]~=nil then radarDynamicWidget[cB.widgetDist]=radarDynamicWidget[cB.widgetDist]+1 else radarDynamicWidget[cB.widgetDist]=1 end else table.insert(radarStatic,cB)if radarStaticWidget[cB.widgetDist]~=nil then radarStaticWidget[cB.widgetDist]=radarStaticWidget[cB.widgetDist]+1 else radarStaticWidget[cB.widgetDist]=1 end end end end end;if(activeRadar.getThreatRateFrom(aW)==2 or activeRadar.getThreatRateFrom(aW)==3 or activeRadar.getThreatRateFrom(aW)==5)and size~=""then cm=cm+1;local cC=string.sub(""..activeRadar.getConstructName(aW).."",1,11)local cE=math.floor(activeRadar.getConstructDistance(aW))if cE>=1000 then cE=''..string.format('%0.1f',cE/1000)..' km ('..string.format('%0.2f',cE/200000)..' su)'else cE=''..cE..' m'end;local cO=tostring(aW):sub(-3)local cP=''..cO..' '..cC..''if activeRadar.getThreatRateFrom(aW)==5 then cn=cn+1;cq=cq..[[
                     <div class="table-row th">
                     <div class="lockedT">
                     <redcolor1>]]..'['..size..'] '..cP..[[</redcolor1><br><distcolor>]]..cE..[[</distcolor>
                     </div>
                     </div>]]else cq=cq..[[
                     <div class="table-row th">
                     <div class="lockedT">
                     <orangecolor>]]..'['..size..'] '..cP..[[</orangecolor><br><distcolor>]]..cE..[[</distcolor>
                     </div>
                     </div>]]end end;if G>50 then G=0;coroutine.yield()end end;if GHUD_show_allies==true then if cl>0 then cs="<alliescolor>Allies:</alliescolor><br><countcolor>"..cl.."</countcolor> <countcolor2>"..conID.."</countcolor2>"else cs="<alliescolor>Allies:</alliescolor><br><countcolor>0</countcolor> <countcolor2>"..conID.."</countcolor2>"end;ci=htmlbasic..[[
               <style>
               .th3>.table-cell3 {
               ...
               </div>]]end;cs="<targetscolor>Targets:</targetscolor>"cu=targetshtml..[[
            <style>
            .th2>.table-cell2 {
            ...
            <div class="table-row2 th2">
            <div class="table-cell2">
            ]]..cs..[[<br><countcolor>]]..idN-cl..[[</colorcount>
            </div>
            </div>
            ]]..cr..[[
            </div>]]if cm==0 then ct="LOCK"cz="#07e88e"cx="OK"cy=cz else ct="LOCKED:"cz="#FFB12C"cx=cm;cy="rgb(0, 191, 255)"end;if cn>0 then ct="ATTACKED:"cz="#fc033d"cx=cn;cy="rgb(0, 191, 255)"end;cw=[[<style>.radarLockstatus {
               position: fixed;
            ...
            <text style="fill: ]]..cy..[[; font-size: 110px; font-weight: bold; text-anchor: middle;" x="256" y="294.054">]]..cx..[[</text>
            </svg>
            </div>]]cv=lockhtml..[[
            <style>
            .th>.table-cell {
            ...
            <rightlocked style="color: ]]..cz..[[;">]]..ct..[[</rightlocked>
            </div>
            </div>
            ]]..cq..[[
            </div>]]if GHUD_show_echoes==true then local cQ=''for cA,aW in pairs(radarDynamicData)do cQ=cQ..'<span style="left:'..cA..'px;height:'..aW..'px;"></span>'end;local cR=''for cA,aW in pairs(radarStaticData)do cR=cR..'<span style="left:'..cA..'px;height:'..aW..'px;"></span>'end;local htmlRadar=htmlRadar..[[
               <div class="radar-widget">
               <div class="d-widget">]]..cQ..[[</div>
               <div class="s-widget">]]..cR..[[</div>
               <div class="labels">
               ...
               ]]radarWidget=htmlRadar else radarWidget=''end;cj=hudvers..[[<div class="hudversion">GHUD v]]..HUD_version..[[</div>]]if GHUD_show_echoes==true then if GHUD_show_allies==true then gunnerHUD=ci..cu..cv..cj..radarWidget..cw else gunnerHUD=cu..cv..cj..radarWidget..cw end else if GHUD_show_allies==true then gunnerHUD=ci..cu..cv..cj..cw else gunnerHUD=cu..cv..cj..cw end end;coroutine.yield()end end;lockhtml=[[<style>
      .table {
         display: table;
      ...
      .warp-scan {
      ...
      </style>]]function zeroConvertToWorldCoordinates(d,system)local e=" *([+-]?%d+%.?%d*e?[+-]?%d*)"local f="::pos{"..e..","..e..","..e..","..e..","..e.."}"local g,h,i,j,k=string.match(d,f)if g==nil or h==nil or i==nil or j==nil or k==nil then system.print("Invalid POS!")return vec3()end;if g=="0"and h=="0"then return vec3(i,j,k)end;j=math.rad(j)i=math.rad(i)local l=atlas[tonumber(g)][tonumber(h)]local m=math.cos(i)local n=vec3(m*math.cos(j),m*math.sin(j),math.sin(i))return vec3(l.center)+(l.radius+k)*n end;function getPipeD(system)if databank_1.getStringValue(1)~=""and databank_1.getStringValue(3)~=""then local aD=""local length1=-700*200000;local cS=800*200000;local cT=pos1;local cU=pos2;local pos111=zeroConvertToWorldCoordinates(cT,system)local pos222=zeroConvertToWorldCoordinates(cU,system)local DestinationCenter=vectorLengthen(pos111,pos222,length1)local DepartureCenter=vectorLengthen(pos111,pos222,cS)local cV=vec3(construct.getWorldPosition())local x=(DestinationCenter-DepartureCenter):normalize()local z=(cV-DepartureCenter):dot(x)/x:dot(x)if z<=0.then return(cV-DepartureCenter):len()elseif z>=(DestinationCenter-DepartureCenter):len()then return(cV-DestinationCenter):len()end;local A=DepartureCenter+z*x;local J=(A-cV):len()if J<1000 then aD=""..string.format("%0.0f",J).." m"elseif J<100000 then aD=""..string.format("%0.1f",J/1000).." km"else aD=""..string.format("%0.2f",J/200000).." su"end;return aD end end;function getPipeW(system)if databank_1.getStringValue(1)~=""and databank_1.getStringValue(3)~=""then showMarker=false;local length1=-700*200000;local cS=800*200000;local cT=pos1;local cU=pos2;local pos111=zeroConvertToWorldCoordinates(cT,system)local pos222=zeroConvertToWorldCoordinates(cU,system)local DestinationCenter=vectorLengthen(pos111,pos222,length1)local DepartureCenter=vectorLengthen(pos111,pos222,cS)local cV=vec3(construct.getWorldPosition())local x=(DestinationCenter-DepartureCenter):normalize()local z=(cV-DepartureCenter):dot(x)/x:dot(x)if z<=0.then return(cV-DepartureCenter):len()elseif z>=(DestinationCenter-DepartureCenter):len()then return(cV-DestinationCenter):len()end;local A=DepartureCenter+z*x;local cW="::pos{0,0,"..math.floor(A.x)..","..math.floor(A.y)..","..math.floor(A.z).."}"system.print("Pipe center")system.setWaypoint(cW)end end;function getPos4Vector(cX)return"::pos{0,0,"..vec3(cX).x..","..vec3(cX).y..","..vec3(cX).z.."}"end;function makeVector(as,at)local au=vec3(at).x-vec3(as).x;local y=vec3(at).y-vec3(as).y;local av=vec3(at).z-vec3(as).z;return vec3(au,y,av)end;function UTC()local cY=curTime-timeZone*3600;return cY end;function UTCscaner(system)local cY=system.getArkTime()-timeZone*3600;return cY end;function vectorLengthen(as,at,aw)local ax=makeVector(as,at)local ay=vec3(ax):len()local az=ay+aw;local aA=az/ay;local aB=ax*aA;local au=vec3(as).x+vec3(aB).x;local y=vec3(as).y+vec3(aB).y;local av=vec3(as).z+vec3(aB).z;local aC=vec3(au,y,av)return aC end;function start(unit,system,text)pos1time=0;pos2time=0;tspeed=0;tspeed1=0;mmode=true;deg2rad=math.pi/180;rad2deg=180/math.pi;ms2kmh=3600/1000;kmh2ms=1000/3600;showMarker=true;if GHUD_export_mode==true then system.print("---------------")system.print("The export mode is enabled ALT+G")else system.print("---------------")system.print("The export mode is disabled ALT+G")end;SU=10;calcTargetSpeed=targetSpeed/3.6;meterMarker=0;if databank_1.getStringValue(1)~=""and databank_1.getFloatValue(2)~=0 and databank_1.getStringValue(3)~=""and databank_1.getFloatValue(4)~=0 then system.print("Coordinates from DB are used!")pos1=databank_1.getStringValue(1)pos2=databank_1.getStringValue(3)pos1time=databank_1.getFloatValue(2)pos2time=databank_1.getFloatValue(4)pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)Pos1=pos1;Pos2=pos2;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;curTime=system.getUtcTime()local lasttime=math.floor(curTime-pos2time)local cZ=pos11:dist(pos22)local c_=pos2time-pos1time;tspeed=cZ/c_;tspeed1=math.floor(cZ/c_*3.6)meterMarker1=lasttime*tspeed+tspeed*4;length1=meterMarker1;lengthSU1=string.format("%0.2f",length1/200000*100/100)meterMarker=lasttime*calcTargetSpeed+calcTargetSpeed*4;length=meterMarker;lengthSU=string.format("%0.2f",length/200000*100/100)resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)system.print("The target flew 20 km "..lengthSU1 .." su, speed "..tspeed1 .." km/h")unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)else databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;system.print("Coordinates are missing set new or export")end end;function inTEXT(unit,system,text)if pos1~=0 and string.find(text,"::pos")and not string.find(text,"m::pos")and pos2==0 and GHUD_export_mode==false then pos2=text;databank_1.setStringValue(3,pos2)pos2time=math.floor(system.getUtcTime())databank_1.setFloatValue(4,pos2time)system.print(text.." pos2 saved")pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)local cZ=pos11:dist(pos22)local c_=pos2time-pos1time;tspeed=cZ/c_;tspeed1=math.floor(cZ/c_*3.6)Pos1=pos1;Pos2=pos2;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;meterMarker1=meterMarker1+tspeed*4;length1=meterMarker1;resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)meterMarker=meterMarker+calcTargetSpeed*4;length=meterMarker;resultVector=vectorLengthen(pos11,pos22,length)Waypoint=getPos4Vector(resultVector)system.print("---------------")system.print("The coordinates are set manually!")posExport1=databank_1.getStringValue(1)posExport2=databank_1.getStringValue(3)timeExport1=math.floor(databank_1.getFloatValue(2))timeExport2=math.floor(databank_1.getFloatValue(4))system.print("The coordinates were exported to screen")screen_1.setCenteredText(posExport1 .."/"..timeExport1 .."/"..posExport2 .."/"..timeExport2)system.print("Target speed: "..tspeed1 .." km/h")unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)end;if pos1==0 and string.find(text,"::pos")and not string.find(text,"m::pos")and GHUD_export_mode==false then pos1=text;databank_1.setStringValue(1,pos1)pos1time=math.floor(system.getUtcTime())databank_1.setFloatValue(2,pos1time)system.print(text.." pos1 saved")end;if text=="n"then pp1=''unit.stopTimer("marker")showMarker=true;databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;SU=10;unit.stopTimer("vectorhud")vectorHUD=''Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;system.print("---------------")system.print("Coordinates have been deleted, set new coordinates")end;if GHUD_export_mode==true and string.find(text,"/")and not string.find(text,"/::pos")then unit.stopTimer("marker")showMarker=true;databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;SU=10;unit.stopTimer("vectorhud")vectorHUD=''Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;local start=0;local d0=string.find(text,"/",start)-1;pos1=string.sub(text,start,d0)system.print(pos1)start=d0+2;d0=string.find(text,"/",start)-1;pos1time=tonumber(string.sub(text,start,d0))system.print(pos1time)start=d0+2;d0=string.find(text,"/",start)-1;pos2=string.sub(text,start,d0)system.print(pos2)start=d0+2;d0=string.find(text,"/",start)pos2time=tonumber(string.sub(text,start,d0))system.print(pos2time)system.print("---------------")system.print("The coordinates have been loaded successfully!")databank_1.setStringValue(1,pos1)databank_1.setFloatValue(2,pos1time)databank_1.setStringValue(3,pos2)databank_1.setFloatValue(4,pos2time)pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)Pos1=pos1;Pos2=pos2;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;oldTime=tonumber(string.sub(text,start,d0))curTime=system.getUtcTime()local lasttime=math.floor(curTime-pos2time)local cZ=pos11:dist(pos22)local c_=pos2time-pos1time;tspeed=cZ/c_;tspeed1=math.floor(cZ/c_*3.6)meterMarker1=lasttime*tspeed+tspeed*4;length1=meterMarker1;lengthSU1=string.format("%0.2f",length1/200000*100/100)meterMarker=lasttime*calcTargetSpeed+calcTargetSpeed*4;length=meterMarker;lengthSU=string.format("%0.2f",length/200000*100/100)resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)system.print("The target flew "..lengthSU1 .." su, speed "..tspeed1 .." km/h")system.setWaypoint(Waypoint1)unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)end;if GHUD_export_mode==true and string.find(text,"/::pos")then unit.stopTimer("marker")showMarker=true;databank_1.setStringValue(1,"")databank_1.setFloatValue(2,0)databank_1.setStringValue(3,"")databank_1.setFloatValue(4,0)pos1=0;pos2=0;lasttime=0;pos1time=0;pos2time=0;meterMarker=0;meterMarker1=0;SU=10;unit.stopTimer("vectorhud")vectorHUD=''Pos1=0;Pos2=0;privMySignAngleR=0;privMySignAngleUp=0;privTargetSignAngleR=0;privTargetSignAngleUp=0;targetVector=vec3.new(0,0,0)targetTracker=false;myAngleR=0;myAngleUp=0;targetAngleR=0;targetAngleUp=0;local start=0;local d0=string.find(text,"/",start)-1;pos1=string.sub(text,start,d0)system.print(pos1)start=d0+2;d0=string.find(text,"/",start)-1;pos1time=tonumber(string.sub(text,start,d0))system.print(pos1time)start=d0+2;d0=string.find(text,"/",start)-1;pos2=string.sub(text,start,d0)system.print(pos2)start=d0+2;d0=string.find(text,"/",start)pos2time=tonumber(string.sub(text,start,d0))system.print(pos2time)system.print("---------------")system.print("The coordinates have been loaded successfully!")databank_1.setStringValue(1,pos1)databank_1.setFloatValue(2,pos1time)databank_1.setStringValue(3,pos2)databank_1.setFloatValue(4,pos2time)pos11=zeroConvertToWorldCoordinates(pos1,system)pos22=zeroConvertToWorldCoordinates(pos2,system)Pos1=pos1;Pos2=pos2;targetVector=makeVector(zeroConvertToWorldCoordinates(Pos1,system),zeroConvertToWorldCoordinates(Pos2,system))targetTracker=true;oldTime=tonumber(string.sub(text,start,d0))curTime=system.getUtcTime()local lasttime=math.floor(curTime-pos2time)local cZ=pos11:dist(pos22)local c_=pos2time-pos1time;tspeed=cZ/c_;tspeed1=math.floor(cZ/c_*3.6)meterMarker1=lasttime*tspeed+tspeed*4;length1=meterMarker1;lengthSU1=string.format("%0.2f",length1/200000*100/100)meterMarker=lasttime*calcTargetSpeed+calcTargetSpeed*4;length=meterMarker;lengthSU=string.format("%0.2f",length/200000*100/100)resultVector1=vectorLengthen(pos11,pos22,length1)Waypoint1=getPos4Vector(resultVector1)system.setWaypoint(Waypoint1)system.print("The target flew "..lengthSU1 .." su, speed "..tspeed1 .." km/h")system.setWaypoint(Waypoint1)unit.setTimer("marker",1)unit.setTimer("vectorhud",0.02)end;if string.find(text,"mar")then if showMarker==true then showMarker=false;system.print("Current target position - OFF")end;local d1=tonumber(text:sub(4))if databank_1.getStringValue(1)~=""and databank_1.getStringValue(3)~=""then local cS=d1*200000;local cT=databank_1.getStringValue(1)local cU=databank_1.getStringValue(3)pos111=zeroConvertToWorldCoordinates(cT,system)pos222=zeroConvertToWorldCoordinates(cU,system)local d2=vectorLengthen(pos111,pos222,cS)local d3=getPos4Vector(d2)system.print(d3 .." waypoint "..d1 .." su")end end end;function tickVector(unit,system,text)if targetTracker==true and targetVector.x~=0 and targetVector.y~=0 and targetVector.z~=0 then local d4=getPipeD(system)local d5=vec3(construct.getWorldOrientationUp()):normalize()local d6=vec3(construct.getWorldOrientationRight()):normalize()local d7=vec3(construct.getWorldOrientationForward()):normalize()local d8=vec3(construct.getWorldVelocity()):normalize()local d9=d8:project_on_plane(d5)local da=d8:project_on_plane(d6)local db=d8:project_on_plane(d7)local dc=db:cross(d5):normalize()myAngleR=d9:angle_between(d7)local dd=utils.sign(dc:angle_between(d7)-math.pi/2)if dd~=0 then myAngleR=myAngleR*dd;privMySignAngleR=dd else myAngleR=myAngleR*privMySignAngleR end;local de=da:cross(d5):normalize()myAngleUp=da:angle_between(-d5)-math.pi/2;local df=utils.sign(de:angle_between(d6)-math.pi/2)if df~=0 then myAngleUp=myAngleUp*df;privMySignAngleUp=df else myAngleUp=myAngleUp*privMySignAngleUp end;local dg=targetVector:normalize()local dh=dg:project_on_plane(d5)local di=dg:project_on_plane(d6)local dj=dg:project_on_plane(d7)local dk=dj:cross(d5):normalize()targetAngleR=dh:angle_between(d7)local dl=utils.sign(dk:angle_between(d7)-math.pi/2)if dl~=0 then targetAngleR=targetAngleR*dl;privTargetSignAngleR=dl else targetAngleR=targetAngleR*privTargetSignAngleR end;local dm=di:cross(d5):normalize()targetAngleUp=di:angle_between(-d5)-math.pi/2;local dn=utils.sign(dm:angle_between(d6)-math.pi/2)if dn~=0 then targetAngleUp=targetAngleUp*dn;privTargetSignAngleUp=dn else targetAngleUp=targetAngleUp*privTargetSignAngleUp end;targetVectorWidget=[[
         ...
         <br>
         <br>
         <bdr>]]..dF..[[</bdr> + <bdr>]]..dJ..[[</bdr> : switch between friends/enemies<br>
         <br>
         <bdr>]]..dF..[[</bdr> + <bdr>]]..dI..[[</bdr> : construct size filter<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>]]..du..[[</bdr> : add/remove selected target from whitelist<br>
         </div>
         <div class="helper2">
         <ibold>TARGET VECTOR:</ibold>
         <br>
         <br>
         <bdr>]]..dE..[[</bdr> : set pos1/pos2 for radar selected target<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>↓↑</bdr> : move destination ±2.5 su<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>←→</bdr> : move destination ±10 su<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>]]..dF..[[</bdr> : destination to closest target pipe<br>
         <br>
         <bdr>]]..dF..[[</bdr> + <bdr>]]..dE..[[</bdr> : on/off export mode<br>
         <br>
         <bdr>]]..dR..[[</bdr> : show/hide current target position (works only when manually setting coordinates or in export mode)<br>
         <br>
         <bdr>]]..dE..[[</bdr> + <bdr>]]..dx..[[</bdr> : switch target position between current speed or targetSpeed from LUA parameters<br>
         </div>
         </div>
         <div class="bottomL">
         <div class="helper3">
         ...
         <br>
         <br>
         <bdr>]]..dC..[[</bdr> : start/stop venting<br>
         <br>
         <bdr>]]..dB..[[</bdr> : on/off shield<br>
         <br>
         <bdr>]]..dA..[[</bdr> : switch AUTO/MANUAL shield mode<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>]]..dA..[[</bdr> : switch shield mode between MAX and 50/50 mode<br>
         <br>
         <bdr>]]..dz..[[</bdr> : agree and apply resists in manual shield mode<br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..du..[[</bdr> : 100% antimatter power<br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..dv..[[</bdr> : 100% electromagnetic power<br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..dw..[[</bdr> : 100% thermic power<br>
         <br>
         <bdr>]]..dI..[[</bdr> + <bdr>]]..dx..[[</bdr> : 100% kinetic power<br>
         <br>
         <bdr>]]..dJ..[[</bdr> + <bdr>]]..du..[[</bdr> : cannon profile<br>
         <br>
         <bdr>]]..dJ..[[</bdr> + <bdr>]]..dv..[[</bdr> : railgun profile<br>
         <br>
         <bdr>]]..dJ..[[</bdr> + <bdr>]]..dw..[[</bdr> : laser profile<br>
         <br>
         <bdr>]]..dJ..[[</bdr> + <bdr>]]..dx..[[</bdr> : universal profile<br>
         </div>
         <div class="helper2">
         <ibold>Other:</ibold>
         <br>
         <br>
         <bdr>]]..dP..[[</bdr> + <bdr>]]..dD..[[</bdr> : lock brake<br>
         <br>
         <bdr>]]..du..[[</bdr> : show/hide planets and planetary periscope<br>
         <br>
         <bdr>]]..dv..[[</bdr> : set destination to planet #1 (closest pipe planets)<br>
         <br>
         <bdr>]]..dw..[[</bdr> : set destination to closest pipe<br>
         <br>
         <bdr>]]..dx..[[</bdr> : set destination to planet #2 (closest pipe planets)<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>]]..dv..[[</bdr> : set destination to destination planet (LUA parameters)<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>]]..dw..[[</bdr> : set destination to custom pipe Destination - Departure (LUA parameters)<br>
         <br>
         <bdr>]]..dD..[[</bdr> + <bdr>]]..dx..[[</bdr> : set destination to departure planet (LUA parameters)<br>
         <br>
         <bdr>]]..dy..[[</bdr> : Helios system map<br>
         </div>
         </div>
         <div class="bottomL">
         <div class="helper3">
         ...
         </html>]]system.print('GHUD Pilot seat v'..HUD_version)system.print(''..dE..' + ←: helper 1')system.print(''..dE..' + →: helper 2')transponder.deactivate()main1=coroutine.create(main)main2=coroutine.create(closestPipe)unit.setTimer('hud',0.016)unit.setTimer('brake',0.15)unit.setTimer('tr',2)unit.setTimer('prealarm',2)if warpdrive~=nil then unit.setTimer('warp',35)end;if collectgarbages==true then unit.setTimer('cleaner',30)end