...
<text x="%f" y="%f" font-size="11px" fill="yellow">%s</text>
      ...
      .warp-scan {
         ...
         <br>
         <bdr>]]..dJ..[[</bdr> + <bdr>]]..dv..[[</bdr> : laser profile<br>
         <br>
         <bdr>]]..dJ..[[</bdr> + <bdr>]]..dw..[[</bdr> : railgun profile<br>
         <br>
