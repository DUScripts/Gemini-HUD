         ...
         if DisplayRadar==true then
            ...
            .svg {
               ...
               if id ~= 0 then
                  ...
                  <text style="fill: rgb(0, 191, 255); font-family: verdana; font-size: 26px; font-style: italic; font-weight: 700; paint-order: stroke; stroke: rgb(0, 0, 0); stroke-width: 2px; text-anchor: end;" transform="matrix(1, 0, 0, 1, -154.09122, 244.195302)"><tspan x="254.529" y="36.003">]]..znak2..[[ ]]..sdist..[[</tspan></text>
